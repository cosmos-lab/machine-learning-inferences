...
ai-project/
|-- README.md
|-- configs/                  # Model, retriever, generator, and pipeline configs
|   |-- retriever.yaml
|   |-- generator.yaml
|   `-- pipeline.yaml
...
|   |   |-- retriever.py
|   |   `-- utils.py
|   |-- generator/            # Text generation / response
|   |   |-- generator.py
|   |   `-- utils.py
|   |-- vector_db/            # FAISS / Chroma related scripts
|   |   |-- faiss_index.py
|   |   `-- utils.py
|   `-- pipeline.py           # Orchestrator combining retriever + generator
|-- mlops/                    # CI/CD, training pipelines, deployment
|   |-- docker/               # Dockerfiles for AI services
|   |   |-- Dockerfile.retriever
|   |   `-- Dockerfile.generator
|   |-- kubernetes/           # K8s manifests / Helm charts
|   |   |-- retriever-deploy.yaml
|   |   `-- generator-deploy.yaml
|   |-- ci/                   # CI/CD pipeline configs
|   |   |-- build.yml
|   |   `-- deploy.yml
|   `-- monitoring/           # Logs, metrics, and model performance tracking
|-- tests/
|   |-- retriever_tests/
|   |-- generator_tests/
|   `-- integration_tests/
|-- requirements.txt
`-- scripts/                  # Utility scripts: train, eval, index, deploy
    |-- train_retriever.py
    |-- train_generator.py
